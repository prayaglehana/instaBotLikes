...
chromedriver_path = 'C:\Downloads\chromedriver.exe' # Change this to your own chromedriver path!
...
hashtag_list = ['travelblog', 'travelblogger', 'motivation','blockchain','entrepreneur','JPMC']

prev_user_list = [] #- if it's the first time you run it, use this line and comment the two below
#prev_user_list = pd.read_csv('20190904-165145_users_followed_list.csv', delimiter=',').iloc[:,1:2] # useful to build a user log
